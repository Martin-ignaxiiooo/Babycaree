...
exports.enable2fa = exports.generate2fa = void 0;
...
const generate2fa = async (req, res) => {
    try {
        ...
        await (0, db_1.query)("UPDATE administradores SET dos_fa_secret = $1 WHERE id = $2", [
            secret.base32,
            adminId
        ]);
        // Generar código QR
...
const enable2fa = async (req, res) => {
    try {
        ...
        const result = await (0, db_1.query)("SELECT dos_fa_secret FROM administradores WHERE id = $1", [adminId]);
        ...
        if (verified) {
            await (0, db_1.query)("UPDATE administradores SET dos_fa_activo = TRUE, requiere_2fa = TRUE WHERE id = $1", [adminId]);
